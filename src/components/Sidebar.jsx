  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ width: '34px', height: '34px', background: isDark ? '#1a1a24' : '#f0ebe3', borderRadius: '10px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', border: `1px solid ${isDark ? 'rgba(255,255,255,0.07)' : 'rgba(0,0,0,0.08)'}` }}>
          ...
          <span style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 800, fontSize: '17px', color: textCol, letterSpacing: '-0.03em', whiteSpace: 'nowrap', opacity: collapsed ? 0 : 1, transition: 'opacity 0.15s', overflow: 'hidden', maxWidth: collapsed ? '0' : '120px' }}>
            Taskflow
          </span>
        </Link>
        ...
        <div style={{ flex: 1, padding: '12px 8px', display: 'flex', flexDirection: 'column', gap: '2px', overflowY: 'auto' }}>
          ...
          <button
            onClick={onNewTask}
            style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: collapsed ? '10px 0' : '10px 12px', justifyContent: collapsed ? 'center' : 'flex-start', margin: '0 0 6px', borderRadius: '10px', cursor: 'pointer', background: isDark ? '#e8a04a' : '#c8533a', color: isDark ? '#1a1000' : '#ffffff', border: 'none', transition: 'all 0.2s', fontFamily: 'DM Sans, sans-serif', fontWeight: 600, fontSize: '13px' }}
        ...
        <div style={{ padding: '8px 8px', borderTop: `1px solid ${border}`, display: 'flex', flexDirection: 'column', gap: '2px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: collapsed ? 'center' : 'space-between', padding: collapsed ? '10px 0' : '10px 12px', borderRadius: '10px', marginTop: '2px', background: isDark ? 'rgba(255,255,255,0.02)' : 'rgba(0,0,0,0.02)', border: `1px solid ${border}` }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
              <div style={{ width: '30px', height: '30px', borderRadius: '50%', flexShrink: 0, background: 'linear-gradient(135deg, #6b7fff, #e8a04a)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: 700, color: '#fff' }}>
                {initials}
              </div>
              {!collapsed && (
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontSize: '12px', fontWeight: 600, color: textCol, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '100px' }}>{firstName}</div>
                  <div style={{ display: 'inline-block', fontSize: '9px', fontWeight: 600, padding: '1px 6px', borderRadius: '20px', marginTop: '2px', background: isAdmin ? 'rgba(107,127,255,0.15)' : 'rgba(78,203,131,0.15)', color: isAdmin ? '#6b7fff' : '#4ecb83', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            ...
            <button
              ...
              style={{ width: '26px', height: '26px', borderRadius: '8px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', border: `1px solid ${isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.09)'}`, color: mutedCol, cursor: 'pointer', transition: 'all 0.15s' }}
            ...
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transform: collapsed ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.25s' }}>
      ...
      <aside
        ...
        style={{ width: '64px', minHeight: '100vh', background: bg, borderRight: `1px solid ${border}`, flexDirection: 'column', flexShrink: 0, position: 'sticky', top: 0, zIndex: 20, overflow: 'hidden' }}
      >
        <Link to="/" style={{ display: 'flex', justifyContent: 'center', padding: '16px 0', borderBottom: `1px solid ${border}`, textDecoration: 'none' }}>
        ...
        <div style={{ flex: 1, padding: '10px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
          ...
          {navItems.map(item => (
            <Link key={item.id} to={item.path} title={item.id} style={mobileNavItemStyle(item)}>
              {item.icon}
            </Link>
          ))}
        </div>
